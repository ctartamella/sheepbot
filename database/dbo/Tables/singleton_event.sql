...
ALTER TABLE [dbo].[singleton_event]
    ADD CONSTRAINT [FK_singleton_event] FOREIGN KEY ([event_id]) REFERENCES [dbo].[event] ([id]);
GO

ALTER TABLE [dbo].[singleton_event]
    ADD CONSTRAINT [FK_singleton_race] FOREIGN KEY ([race_id]) REFERENCES [dbo].[race] ([id]);
GO
...
ALTER TABLE [dbo].[singleton_event]
    ADD CONSTRAINT [PK_singleton_event] PRIMARY KEY CLUSTERED ([event_id] ASC);
GO
