...
ALTER TABLE [dbo].[series_event]
    ADD CONSTRAINT [PK_series_event] PRIMARY KEY CLUSTERED ([event_id] ASC, [race_id] ASC);
GO
...
ALTER TABLE [dbo].[series_event]
    ADD CONSTRAINT [FK_series_event_event] FOREIGN KEY ([event_id]) REFERENCES [dbo].[event] ([id]);
GO

ALTER TABLE [dbo].[series_event]
    ADD CONSTRAINT [FK_series_event_race] FOREIGN KEY ([race_id]) REFERENCES [dbo].[race] ([id]);
GO
